...
function App() {
  ...
  const [hide, setHide] = useState("hide menu");
  return (
    <div className="App">
      <button
        onClick={() => {
          options.current.classList.toggle("hidden");
          hide == "hide menu" ? setHide("show menu") : setHide("hide menu");
        }}
      ...
      <div className="options" ref={options}>
        <div className="userDiv">
          ...
          <div className="forbiddenDiv">
            <h3>Forbidden words</h3>
            <div className="forbidden1">
              <input type="text" />
              <button
                onClick={(ev) => {
        ...
        <div className="passwordDiv">
          <h2>Password</h2>
          <p>
            -1 for any, 0 for not allowed, 1 to 10 for minimun times to
            appear.
          </p>
          <p> Needs to be checked to apply</p>
          <div>
